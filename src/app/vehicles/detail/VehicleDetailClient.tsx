        ...
        <div className="bg-white rounded-3xl p-6 border border-slate-200/80 shadow-sm space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-3 py-2 rounded-xl bg-sky-600 hover:bg-sky-700 text-white text-xs font-bold"
            >
          ...
          {equipment.length === 0 && (
            <p className="text-xs text-slate-400">No equipment assigned yet. Use “Assign Equipment” to move inventory from the shop or create a new item.</p>
          )}
        </div>
      )}
      ...
      {assignModalOpen && (
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl p-6 w-full max-w-lg shadow-2xl border border-slate-100">
            ...
            <p className="text-xs text-slate-500 mb-4">Select from in-shop inventory or create and assign a new asset.</p>
            ...
            <div className="space-y-4">
              <label className="flex items-start gap-2 p-3 rounded-xl border border-slate-200">
                ...
                <div className="flex-1">
                  <p className="text-xs font-bold text-slate-900">Select from existing inventory</p>
                  <select
                  ...
                  <input
                    ...
                    className="mt-2 w-full px-3 py-2 rounded-xl border border-slate-200 text-xs disabled:bg-slate-100"
              ...
              <label className="flex items-start gap-2 p-3 rounded-xl border border-slate-200">
                ...
                <div className="flex-1">
                  <p className="text-xs font-bold text-slate-900">Create and assign new item</p>
                  <input
            ...
            <div className="flex gap-2 mt-5">
              <button type="button" onClick={() => setAssignModalOpen(false)} className="flex-1 py-2.5 rounded-xl border border-slate-200 text-slate-600 font-bold text-xs">Cancel</button>
              <button type="button" onClick={submitAssignment} disabled={assignLoading} className="flex-1 py-2.5 rounded-xl bg-sky-600 text-white font-bold text-xs disabled:opacity-60">
